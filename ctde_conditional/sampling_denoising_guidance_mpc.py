...
from utils.conditional_Action_DiT_denoising_guidance import Conditional_ODE
...
for i in range(10):
    ...
    np.save("sampled_trajs/mpc_denoising_guidance_P10E1/mpc_traj1_%s.npy" % i, planned_traj1)
    ...
    np.save("sampled_trajs/mpc_denoising_guidance_P10E1/mpc_traj2_%s.npy" % i, planned_traj2)