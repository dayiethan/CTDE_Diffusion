...
# # 8) Save models
# torch.save(G1.state_dict(), "trained_models/magail/G1_ctde.pth")
# torch.save(G2.state_dict(), "trained_models/magail/G2_ctde.pth")
# torch.save(D.state_dict(),  "trained_models/magail/D_ctde.pth")
