...
for i in range(100):
    ...
    np.save("sampled_trajs/mpc_P25E1_nolf_nofinalpos_matchtrain_50k_seeded/mpc_traj1_%s.npy" % i, planned_traj1)

    planned_traj2 = planned_trajs[1] * std2 + mean2

    np.save("sampled_trajs/mpc_P25E1_nolf_nofinalpos_matchtrain_50k_seeded/mpc_traj2_%s.npy" % i, planned_traj2)
