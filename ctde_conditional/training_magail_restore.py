...
# 8) Save models
save_path_G1 = "trained_models/magail/G1_restore_big.pth"
save_path_G2 = "trained_models/magail/G2_restore_big.pth"
save_path_D  = "trained_models/magail/D_restore_big.pth"
...
for i in range(num_samples):
    ...
    goal1 =  final_point1 + noise_std * np.random.randn(2)
    ...
    np.save(f"sampled_trajs/magail_restore_big/vary_init/mpc_traj1_{i}.npy", traj1)
    traj2 = sample_trajectory(G2, init2, goal2, T)
    np.save(f"sampled_trajs/magail_restore_big/vary_init/mpc_traj2_{i}.npy", traj2)
...
for i in range(N):
    np.save(f"sampled_trajs/magail_restore_big/static_init/mpc_traj1_{i}.npy", rollouts1[i])
    np.save(f"sampled_trajs/magail_restore_big/static_init/mpc_traj2_{i}.npy", rollouts2[i])
