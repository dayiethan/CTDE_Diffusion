...
action_cond_ode.load(extra="_P25E3_reactive2")
...
for i in range(100):
    ...
    planned_trajs = reactive_mpc_plan_guidesample(action_cond_ode, env, [initial1, initial2], [final1, final2], 0, segment_length=H, total_steps=T, n_implement=5)

    planned_traj1 =  planned_trajs[0] * std + mean

    np.save("sampled_trajs/mpc_P25E3_5/mpc_traj1_%s.npy" % i, planned_traj1)

    planned_traj2 = planned_trajs[1] * std + mean

    np.save("sampled_trajs/mpc_P25E3_5/mpc_traj2_%s.npy" % i, planned_traj2)
