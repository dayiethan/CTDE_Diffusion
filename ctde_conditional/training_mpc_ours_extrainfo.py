...
mean_orig1 = np.mean(orig1, axis=(0,1))
std_orig1 = np.std(orig1, axis=(0,1))
mean_orig2 = np.mean(orig2, axis=(0,1))
std_orig2 = np.std(orig2, axis=(0,1))
orig1 = (orig1 - mean_orig1) / std_orig1
orig2 = (orig2 - mean_orig2) / std_orig2
...
obs2 = np.hstack([obs_init2, obs_final2, obs_init1])
obs_temp1 = obs1
obs_temp2 = obs2
...
for i in range(100):
    ...
    np.save(f"sampled_trajs/mpc_P25E1_ours_extrainfo_seed{seed}/mpc_traj1_{i}.npy", planned_traj1)

    planned_traj2 = planned_trajs[1] * std2 + mean2

    np.save(f"sampled_trajs/mpc_P25E1_ours_extrainfo_seed{seed}/mpc_traj2_{i}.npy", planned_traj2)
