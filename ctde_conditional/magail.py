...
torch.save(generator.state_dict(),    'trained_models/magail/generator.pth')
torch.save(discriminator.state_dict(),'trained_models/magail/discriminator.pth')
generator.load_state_dict(torch.load('trained_models/magail/generator.pth'))
discriminator.load_state_dict(torch.load('trained_models/magail/discriminator.pth'))
