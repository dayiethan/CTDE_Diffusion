...
for i in range(100):
    ...
    np.save("sampled_trajs/mpc_P25E5_2/mpc_traj1_%s.npy" % i, planned_traj1)

    planned_traj2 = planned_trajs[1] * std + mean

    np.save("sampled_trajs/mpc_P25E5_2/mpc_traj2_%s.npy" % i, planned_traj2)
