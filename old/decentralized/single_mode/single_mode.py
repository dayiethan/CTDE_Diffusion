...
denoiser1 = DiT1d(x_dim=2, attr_dim=1, d_model=384, n_heads=6, depth=12, dropout=0.1)
denoiser2 = DiT1d(x_dim=2, attr_dim=1, d_model=384, n_heads=6, depth=12, dropout=0.1)
denoiser1.load_state_dict(torch.load("checkpoints_new/unet1_diff_tran_epoch4999.pth"))
denoiser2.load_state_dict(torch.load("checkpoints_new/unet2_diff_tran_epoch4999.pth"))
