...
obs_init2 = expert_data2[:, 4, :] # conditioning on the future state bexcause we are training a leader-follower model
...
action_cond_ode.save(extra="_H25_mpc_leader_follower_I_5")
