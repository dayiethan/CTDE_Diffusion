...
two_agent_gnn = TwoAgentTrajectoryGNN(input_dim=4, hidden_dim=256, embedding_dim=4, horizon=10, action_dim=2)
...
trainer.save(path='trained_models/gnn_baseline_recurrent.pt')
...
for i in range(10):
    ...
    plt.savefig("figs/T10_2_gnn/plot%s.png" % (i+10))