...
obs1 = np.hstack([obs_init1, obs_init2, obs_init3])
obs2 = np.hstack([obs_init2, obs_init1, obs_init3])
obs3 = np.hstack([obs_init3, obs_init1, obs_init2])
obs_temp1 = obs1
obs_temp2 = obs2
obs_temp3 = obs3
...
for i in range(100):
    ...
    np.save("sampled_trajs/mpc_P25E1_400demos_06demonoise_06samplenoise_200N_vettedinitfinal_separatenorm_nofinalpos/traj1_%s.npy" % i, planned_traj1)

    planned_traj2 = planned_trajs[1] * std2 + mean2
    np.save("sampled_trajs/mpc_P25E1_400demos_06demonoise_06samplenoise_200N_vettedinitfinal_separatenorm_nofinalpos/traj2_%s.npy" % i, planned_traj2)

    planned_traj3 = planned_trajs[2] * std3 + mean3
    np.save("sampled_trajs/mpc_P25E1_400demos_06demonoise_06samplenoise_200N_vettedinitfinal_separatenorm_nofinalpos/traj3_%s.npy" % i, planned_traj3)
