...
obs2 = np.hstack([obs_init2, obs_final2, obs_init1, obs_final1, obs_init3, obs_final3])
obs3 = np.hstack([obs_init3, obs_final3, obs_init1, obs_final1, obs_init2, obs_final2])
obs_temp1 = obs1
obs_temp2 = obs2
obs_temp3 = obs3
