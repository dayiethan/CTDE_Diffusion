...
if __name__ == '__main__':
    ...
    evaluator.init(log_dir="checkpoints", condition_guidance_w=1.2)

    renderer = SwapRenderer(env_type="swap", env="TwoUnicycle")
    ...
    transition_dim = env.state_size  # adjust if needed
    ...
    conv_model = ConvAttentionDeconv(
        ...
        dim_mults=(1, 2, 4, 8),    # example multipliers; adjust based on your needs
        n_agents=2,             # change if you have multiple agents
    ...
    trainer = Trainer(
        ...
        dataset=dataset,
        renderer=renderer,               # if you have a renderer, pass it here
        ema_decay=0.995,
        train_batch_size=32,
        train_lr=0.0002,
