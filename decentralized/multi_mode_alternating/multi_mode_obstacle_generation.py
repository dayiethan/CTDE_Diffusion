...
denoiser1 = DiT1d(x_dim=2, attr_dim=1, d_model=64, n_heads=4, depth=3, dropout=0.1)
denoiser2 = DiT1d(x_dim=2, attr_dim=1, d_model=64, n_heads=4, depth=3, dropout=0.1)
denoiser1.load_state_dict(torch.load("checkpoints_obstacle/unet1_diff_tran_epoch1999.pth"))
denoiser2.load_state_dict(torch.load("checkpoints_obstacle/unet2_diff_tran_epoch1999.pth"))
...
plt.scatter(initial_point1[0], initial_point1[1], c='red', s=100, label='Start/End')
plt.scatter(final_point1[0], final_point1[1], c='red', s=100, label='Start/End')
...
plt.ylabel('Y')
plt.grid(True)
plt.savefig('figs_obstacle/expert_vs_generated_trajectories.png')
plt.show()
