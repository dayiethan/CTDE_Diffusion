...
# Training
end = "_lift_mpc_P%sE1_%sT_crosscondfinalpos_gripcond" % (H, T)
...
for i in range(10):
    ...
    np.save("samples/P%sE1_%sT_gripcond/planned_traj1_%s_new.npy" % (H, T, cond_idx), planned_traj1)
    planned_traj2 = planned_trajs[1] * std + mean
    np.save("samples/P%sE1_%sT_gripcond/planned_traj2_%s_new.npy" % (H, T, cond_idx), planned_traj2)