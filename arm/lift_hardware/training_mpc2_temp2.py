...
action_cond_ode.train([actions1, actions2], [attr1, attr2], int(5*n_gradient_steps), batch_size, extra="_lift_mpc_P50E5_crosscond_sparsedata", endpoint_loss=False)
action_cond_ode.save(extra="_lift_mpc_P50E5_crosscond_sparsedata")
action_cond_ode.load(extra="_lift_mpc_P50E5_crosscond_sparsedata")
...
np.save("samples/P50E5_crosscond_sparsedata/planned_traj1_0.npy", planned_traj1)
planned_traj2 = planned_trajs[1] * std + mean
np.save("samples/P50E5_crosscond_sparsedata/planned_traj2_0.npy", planned_traj2)