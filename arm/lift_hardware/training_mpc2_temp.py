...
# Training
end = "_lift_mpc_P50E1_500T_crosscondfinalpos_nolf"
...
np.save("samples/P50E1_500T_crosscondfinalpos_nolf/planned_traj1_" + str(cond_idx) + ".npy", planned_traj1)
planned_traj2 = planned_trajs[1] * std + mean
np.save("samples/P50E1_500T_crosscondfinalpos_nolf/planned_traj2_" + str(cond_idx) + ".npy", planned_traj2)