...
with open("data/hammer_states_rotvec_20.npy", "rb") as f:
    obs = np.load(f)
...
action_cond_ode.train([actions1, actions2], [attr1, attr2], int(5*n_gradient_steps), batch_size, extra="_T340_rotvec_hammer_20", endpoint_loss=False)
action_cond_ode.save(extra="_T340_rotvec_hammer_20")
action_cond_ode.load(extra="_T340_rotvec_hammer_20")