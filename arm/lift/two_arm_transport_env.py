...
class TwoArmTransportRole(TwoArmEnv):
    """
    ...
    def _load_model(self):
        ...
        box1 = BoxObject(name="box1", size=[0.02, 0.02, 0.02], material=redwood)
        box2 = BoxObject(name="box2", size=[0.02, 0.02, 0.02], material=redwood)
        ...
        self.model = ManipulationTask(
            ...
            mujoco_objects=[payload, box1, box2],
        )
    ...
    def _get_placement_initializer(self):
        ...
        object_names = ["payload", "box1", "box2"]
