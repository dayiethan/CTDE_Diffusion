...
with open("data/pot_states_rotvec_100.npy", "rb") as f:
    obs = np.load(f)
obs_init1 = expert_data1[:, 0, :]
obs_init2 = expert_data2[:, 0, :]
obs = np.repeat(obs, repeats=T, axis=0)
obs1 = np.hstack([obs_init1, obs])
obs2 = np.hstack([obs_init2, obs_init1, obs, dist0])
...
# Training
end="_lift_mpc_P25E1_crosscond_nofinalpos_fullstate_lf_sitedata_grippauseshort_addpoints_rotvec_separatenorm_dist"
