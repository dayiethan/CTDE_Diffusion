...
action_cond_ode.train([actions1, actions2], [attr1, attr2], int(5*n_gradient_steps), batch_size, extra="_lift_mpc_P25E5", endpoint_loss=False)
action_cond_ode.save(extra="_lift_mpc_P25E5")
