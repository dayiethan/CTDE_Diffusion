...
class PolicyPlayer:
    ...
    def get_demo(self, seed, cond_idx, extra, H=25, T=250):
        ...
        n_samples = 1
        # breakpoint()
        planned_trajs = self.reactive_mpc_plan(model, [expert_data1[cond_idx, 0, :3], expert_data2[cond_idx, 0, :3]], obs[cond_idx], segment_length=H, total_steps=T, n_implement=1)
...
if __name__ == "__main__":
    ...
    cond_idx = 0
    player.get_demo(seed = cond_idx*10, cond_idx = cond_idx, extra="_lift_mpc_P25E1_nolf", H=25, T=250)
