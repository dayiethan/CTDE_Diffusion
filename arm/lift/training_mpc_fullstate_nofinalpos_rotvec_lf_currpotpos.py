...
# np.save("data/arms_mean.npy", mean)
# std = np.std(combined_data, axis=(0,1))
# np.save("data/arms_std.npy", std)
# pot_mean = np.mean(pot_seq, axis=(0, 1))
# np.save("data/pot_mean.npy", pot_mean)
# pot_std  = np.std(pot_seq, axis=(0, 1))
# np.save("data/pot_std.npy", pot_std)

mean_arm1 = np.mean(expert_data1, axis=(0, 1))
mean_arm2 = np.mean(expert_data2, axis=(0, 1))
np.save("data/mean_arm1.npy", mean_arm1)
np.save("data/mean_arm2.npy", mean_arm2)
std_arm1 = np.std(expert_data1, axis=(0, 1))
std_arm2 = np.std(expert_data2, axis=(0, 1))
np.save("data/std_arm1.npy", std_arm1)
np.save("data/std_arm2.npy", std_arm2)
mean_pot1 = np.mean(pot1, axis=(0, 1))
mean_pot2 = np.mean(pot2, axis=(0, 1))
np.save("data/mean_pot1.npy", mean_pot1)
np.save("data/mean_pot2.npy", mean_pot2)
std_pot1 = np.std(pot1, axis=(0, 1))
std_pot2 = np.std(pot2, axis=(0, 1))
np.save("data/std_pot1.npy", std_pot1)
np.save("data/std_pot2.npy", std_pot2)
...
actions1 = torch.from_numpy(expert_data1[:, :H, :]).float().to(device)
actions2 = torch.from_numpy(expert_data2[:, :H, :]).float().to(device)
...
# Training
end="_lift_mpc_P25E1_crosscond_nofinalpos_fullstate_lf_sitedata_grippauseshort_addpoints_currpotpos_rotvec"
