...
action_cond_ode.train([actions1, actions2], [attr1, attr2], int(5*n_gradient_steps), batch_size, extra="_T250_rotvec_pot_100", endpoint_loss=False)
action_cond_ode.save(extra="_T250_rotvec_pot_100")
action_cond_ode.load(extra="_T250_rotvec_pot_100")